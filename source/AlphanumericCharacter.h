#ifndef ALPHANUMERICCHARACTERS_H
#define ALPHANUMERICCHARACTERS_H

#include <QPainter>
#include <QGraphicsItem>

class AlphanumericCharacter: public QObject, public QGraphicsItem
{
    Q_OBJECT
public:
    AlphanumericCharacter(uint8_t index, uint8_t pixelSize);
...
signals:
  ...
  void hoverEnter(uint8_t index);
  void hoverLeave(uint8_t index);

private:

  uint8_t _pixelSize = 10;
  uint8_t _row = 5;
  uint8_t _collum = 8;
  uint8_t _index = 0;
...
#endif // ALPHANUMERICCHARACTERS_H
